...
if( $_SERVER['REQUEST_METHOD'] == 'GET' ){
    ...
    do{
        if( empty($id) || empty($name) || empty($city) || empty($phone_no) || empty($age) || empty($gender) || empty($health_condition) || empty($blood_groups) || empty($hospital) ){
            $errorMessage = "All the fields are required";
            break;
        }

        $sql = "UPDATE donors SET name='$name', city='$city',phone_no='$phone_no',age='$age',gender='$gender',health_condition='$health_condition',blood_groups='$blood_groups',hospital='$hospital' WHERE id='$id'";
...
<body class="background">
    <div class="container my-5 layer text">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label">Health Conditions</label>
                <div class='col-sm-6'>
        ...
        ?>
            ...
            <div class="row mb-3">
                ...
                <div class='col-sm-3 d-grid'>
                    <a class="btn btn-outline-primary" href="/bloodbank_dbms/admin.php#pchart" role="button">Cancel</a>
                </div>
            </div>
        </form>
    </div>
